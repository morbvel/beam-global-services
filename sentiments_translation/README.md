# Sentiment analysis with translation API Rest
...
```
{
  ...
  "translation": "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas finibus libero quis lectus consequat",
  "score": 0.8
  "magnitude": 0.75
}
```
...
## Deployment
As this service depends on ***sentiments*** and ***translation***, those URL must be updated on *server.js* file:

```
https://text-sentiment-dot-bsddl-161716.appspot.com -> *new score url*
```
```
https://text-traslation-dot-bsddl-161716.appspot.com -> *new translation url*
```
