const linealChart = (idLinealChart, options) => {
  const selector = document.querySelector(`#${idLinealChart}`)
  ...
  return new Chart(document.getElementById(idLinealChart), {
    type: 'line',
    data: {
...
module.exports = {
  linealChart: function(idLinealChart, options){
    return linealChart(idLinealChart, options)
  }
}
